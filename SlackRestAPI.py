...
class SlackGroups(SlackClient):
    ...
    def invite_user_to_private_channel(self):
    ...
    def list_private_channels(self):
        ...
        request = requests.get(url,auth=HTTPBasicAuth('',self.client.tokne),params=body)
    ...
    def open_private_channel(self):

        url  = base_url + '/groups.open'
    ...
    def rename_private_channel(self):

        url = base_url + '/groups.rename'
    ...
    def retrieve_private_channel_message_thread(self):

        url = base_url + '/groups.replies'
    ...
    def set_private_channel_purpose(self):

        url = base_url + '/groups.setPurpose'
    ...
    def set_private_channel_topic(self):

        url = base_url + '/groups.setTopic'
...
class SlackIM(SlackClient):
    ...
    def list_direct_message_channels(self):
...
class SlackMPIM(SlackClient):
    ...
    def get_mpim_channels(self):

        url = base_url + '/mpim.list'
    ...
    def set_mpim_read_cursor(self):

        url = base_url + '/mpim.mark'
